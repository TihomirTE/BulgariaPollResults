function results() {
    let resultsData = {
        PartiesResults: {
            ...
            6: { name: "ВОЛЯ", number: 6, result: 4.26, mandads: 6, abbreviationName: "ВОЛЯ" },
            ...
            9: { name: "ДВИЖЕНИЕ ЗА ПРАВА И СВОБОДИ – ДПС", number: 9, result: 9.24, mandads: 26, abbreviationName: "ДПС" },
            10: { name: "БСП ЗА БЪЛГАРИЯ", number: 10, result: 27.93, mandads: 80, abbreviationName: "БСП" },
            11: { name: "ПП ГЕРБ", number: 11, result: 33.54, mandads: 95, abbreviationName: "ГЕРБ" },
            ...
            17: { name: "ОБЕДИНЕНИ ПАТРИОТИ – НФСБ, АТАКА И ВМРО", number: 17, result: 9.31, mandads: 27, abbreviationName: "ОБЕДИНЕНИ ПАТРИОТИ" },
